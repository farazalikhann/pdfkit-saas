...
export const HOME_FAQS: FaqItem[] = [
  {
    ...
    a: "For every tool except Summarize and Translate, yes: your file is processed entirely in your browser and never touches a server. Those two AI tools extract text locally and send only that extracted text, never the file itself, through OpenRouter to a third-party AI model provider to generate a summary or translation.",
  },
  {
